    ...
    <div class="modal-dialog"  role="document">
        <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel1">رخص الحرف والصناعات  <span id=""></span></h4>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <table width="100%" class="detailsTB table jobLic_table">
                                    ...
                                    <tr>
                                    <th width="30px">#</th>
                                    <th width="50px">رقم الرخصة</th>
                                    <th width="200px">الاسم التجاري</th>
                                    <th width="80px">تاريخ البداية </th>
                                    <th width="80px">تاريخ النهاية </th>
                                    <th width="60px"> نوع الحرفة </th>
