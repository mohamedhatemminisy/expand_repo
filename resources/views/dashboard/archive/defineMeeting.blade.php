            ...
            select: function( event, ui ) {
                row='<tr>'
                    ...
                    row+='	<td >'
                        ...
                        +'	<i class="fas fa-trash" id="plusElement2"></i>'
                        +'	</span>'
                        +'	</div>'
                        +'	</td>'
                        +'</tr>';
                    ...
                    success: function (data) {
                        ...
                        for(j=0; j<data.meetingTitleList.length;j++) {
                            row += '<tr>'
                                ...
                                + '</td>'
                                + '<td width="40px">'
                                + '<i class="fa fa-edit" id="trash" aria-hidden="true" style="color:#1E9FF2;padding-top:10px;position: relative;left: 3%;cursor: pointer;" onclick="editConstant1('+data.meetingTitleList[j].pk_i_id+',\''+data.meetingTitleList[j].meetingnamear+'\')"></i>'
    ...
    function editConstant1(id,title){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for(j=0; j<data.meetingTitleList.length;j++) {
                    row='<tr>'
                        +'<td>'+data.meetingTitleList[j].memername
                        +'		<input type="hidden" name="MemberNameList[]" value="'+data.meetingTitleList[j].memername+'" >'
                        +'</td>'
                        +'<td>'
                        +'		<input type="hidden" name="MemberIDList[]" value="'+data.meetingTitleList[j].memberID+'" >'
                        +'</td>';
                    row+='	<td style="border: hidden;" >'
                        +'	<div class="input-group-append" style="margin-left: 0px !important" onclick="deletemember(this,'+data.meetingTitleList[j].memberID+','+id+')">'
                        +'	<span class="input-group-text input-group-text2" style="margin-left: 0;" >'
                        +'	<i class="fas fa-trash" id="plusElement2"></i>'
                        +'	</span>'
                        +'	</div>'
                ...
                for(j=0; j<data.allowedList.length;j++) {
                    row='<tr>'
                        +'<td>'+data.allowedList[j].NameAR
                        +'</td>';
                    row+='	<td style="border: hidden;" >'
                        +'	<div class="input-group-append" style="margin-left: 0px !important" onclick="deletePermember('+data.allowedList[j].pk_i_id+')">'
                        +'	<span class="input-group-text input-group-text2" style="margin-left: 0;" >'
                        +'	<i class="fas fa-trash" id="plusElement2"></i>'
                        +'	</span>'
                        +'	</div>'
